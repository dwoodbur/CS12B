// $Id: voidstar.c,v 1.38 2013-02-28 18:16:17-08 - - $
...
/*
//TEST// valgrind --leak-check=full ./voidstar \
//TEST//          >voidstar.out 2>voidstar.err
//TEST// more voidstar.out voidstar.err >voidstar.lis </dev/null
