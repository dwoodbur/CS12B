...
// $Id: misclib.java,v 1.1 2013-01-04 19:10:39-08 - - $
...
class misclib {
	...
	public static final String program_name = basename (getProperty ("java.class.path"));
	...
	public static void warn (Object... args) {
		...
		for (Object arg: args) err.printf (": %s", args);
		err.printf ("%n");
	}
